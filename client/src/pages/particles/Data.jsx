...
export const HeroTexts = [
    {
        Heading: "Unleash Your Inner Beauty!",
        Paragraph: "Welcome to Salon Toronto, where Beauty  meets fun! Get ready to unleash your inner strength and transform your life!",
        Button: "Our services & treatments!",
        to:'/services'
    },
    {
    ...
    {
        Heading:"Unlock the door to timeless elegance!",
        Paragraph: "At our salon, Beauty is not just a routine; it's an enjoyable expoerience! Join us in this experirence expedition, where pleasure and results go hand in hand!",
        Button: "Contact us!",
        to:'/contact'
    }
]
...
export const AboutTexts = {
    firstText: "About Salon Torornto",
    secondText: "Welcome",
    caption: "Welcome to Salon Torornto, where beauty meets community and transformation happens!",
    paragraph1: "At Salon Torornto, we are more than just a salon; we are a passionate and supportive fitness family dedicated to helping you achieve your health and wellness goals. Our mission is to create a positive and empowering environment that inspires you to challenge yourself, embrace a healthy lifestyle, and discover the best version of yourself.",
}
