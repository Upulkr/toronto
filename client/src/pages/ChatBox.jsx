   ...
   function onHandleSubmit(e){
    ...
    return (
        ...
        onClick={()=>setOpen(!open)}
          className=" fixed bottom-3 right-4 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border-black rounded-full w-16 h-16  hover:bg-gray-700 m-0 cursor-pointer border-black-200 bg-none p-0 normal-case leading-5 hover:text-gray-900"
          type="button"
        ...
        >
          <svg
            ...
            className="text-black block border-black-200 align-middle   bg-transparent"
          >
            <path
              d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"
              className="border-black-200"
            ></path>
          </svg>
        </button>
        {open? <div
          style={{ boxShadow: "0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
          className="fixed bottom-[calc(4rem+1.5rem)] right-0 sm:mr-4  bg-white dark:bg-black p-6 rounded-lg border border-[#e5e7eb] w-full sm:w-[440px] h-[620px]"
        >
          {/* Heading */}
          ...
          >
            ...
            <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1 grid sm:grid-cols-1">
              ...
              <p className="leading-relaxed">
                <span className="block font-bold text-gray-700  ">AI </span><p className="">Hi, how can
                I help you today?</p>
              </p>
            </div>
            {/*  User Chat Message */}
